      ...
      <div className="max-w-6xl mx-auto space-y-12">
            ...
            <div className="p-8 flex-grow flex flex-col justify-between">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8 max-w-sm">
                <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 text-center">
                  ...
                  <span className="block text-3xl font-extrabold text-indigo-600 mt-1">{stats?.postsCount || 0}</span>
                </div>
                <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 text-center">
                  <span className="block text-slate-400 text-xs font-bold uppercase tracking-wider">Total Views</span>
                  <span className="block text-3xl font-extrabold text-emerald-600 mt-1">{stats?.totalViews || 0}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="space-y-6">
          <div className="flex justify-between items-center border-b border-slate-200 pb-4">
            <h2 className="text-2xl font-extrabold text-slate-800 tracking-tight">My Gallery</h2>
