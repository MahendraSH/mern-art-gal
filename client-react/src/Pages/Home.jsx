...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-slate-200 via-fuchsia-50 to-cyan-100 flex flex-col justify-between">
      {/* Hero Section */}
      <section className="text-gray-600 py-16 px-4 sm:px-6 lg:px-8 flex-grow flex items-center">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Hero text */}
          <div className="space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-600 text-xs font-bold uppercase tracking-wider shadow-sm">
              ✨ Discover and Showcase
            </div>
            <h1 className="text-4xl sm:text-6xl font-extrabold text-slate-800 tracking-tight leading-none">
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
              ...
              <Link
                to="/galary"
                className="btn btn-outline px-8 py-3 rounded-xl border-slate-300 text-slate-700 hover:bg-slate-100 hover:text-slate-800 hover:border-slate-400 transition-all duration-300"
              >
                Explore Gallery
              </Link>
            </div>
          ...
          <div className="relative flex justify-center lg:justify-end">
            ...
            <div className="absolute bottom-4 left-4 w-72 h-72 bg-indigo-300 rounded-full mix-blend-multiply filter blur-2xl opacity-30 animate-pulse delay-1000"></div>
            
            <div className="relative max-w-lg w-full rounded-3xl overflow-hidden shadow-2xl border-4 border-white/80 backdrop-blur-sm bg-white/10 transition-transform duration-500 hover:scale-[1.01]">
              <img
      ...
      <section className="bg-white border-t border-slate-100 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-xl mx-auto mb-12">
            <h2 className="text-3xl font-extrabold text-slate-800 tracking-tight">How ArtGal Works</h2>
            <p className="text-slate-500 mt-2 font-medium">Simple steps to kickstart your artistic portfolio showcase</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 shadow-sm transition-all duration-300 hover:shadow-md">
              <div className="w-12 h-12 rounded-xl bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold text-xl mb-4">
                1
              </div>
              <h3 className="text-lg font-bold text-slate-800">Set Up Profile</h3>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 shadow-sm transition-all duration-300 hover:shadow-md">
              ...
              <h3 className="text-lg font-bold text-slate-800">Upload Artworks</h3>
              <p className="text-slate-500 text-sm mt-2">
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 shadow-sm transition-all duration-300 hover:shadow-md">
              ...
              <h3 className="text-lg font-bold text-slate-800">Track Visual Analytics</h3>
              <p className="text-slate-500 text-sm mt-2">
